...
import { ChatGroupsModalComponent } from './chat-contacts/chat-groups-modal/chat-groups-modal.component';
import { ChatSelfModalComponent } from './chat-contacts/chat-self-modal/chat-self-modal.component';
...
@NgModule({
  declarations: [
    ...
    ChatGroupsModalComponent,
    ChatSelfModalComponent,
  ],
  imports: [
    BrowserModule,
    FormsModule,
